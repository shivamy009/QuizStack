...
import AdminquizForm from '../../../frontend/src/Admin/AdminquizForm.jsx'
...
const AdminProfile = () => {
  ...
  return (
    ...
    <nav className="mt-6 w-full flex flex-col items-center">
      ...
      <Link className=' mt-2 mb-4' to="/adminProfile"><li className="px-4 py-2 hover:bg-gray-700 cursor-pointer flex"><LayoutDashboard className=' mr-2' /> Dashboard</li></Link>
      ...
      <Link className=' my-2' to="/adminProfile/settings"> <li className="px-4 py-2 hover:bg-gray-700 cursor-pointer flex"><Settings className=' mr-2' />  Settings</li></Link>
